...
import './Article.css'
import {Card,ThickCard,Massages} from '../Items'
...
export default function Articles() {
  return (
    <>
      <div className="row first_row" id='home'>
        <div className="col-md-12">
          <h1>most reliable crypto investment platform</h1>
        </div>
      </div>
      <div className="row">
        <div className="col-md-12 second_row">
          <h1>What is Sipto?</h1>
          <p>
      ...
      <div className="row third_row" id='Cards'>
        <Card img={imgUrl1} />
        <Card img={imgUrl2} />
        <Card img={imgUrl3} />
      </div>
      ...
      <div className="row fifth_row ">
        <ThickCard img={imgUrl4} />
        <ThickCard img={imgUrl5} />
        <ThickCard img={imgUrl6} />
      </div>
      <div className="row sixth_row" id='Invest'>
        <div className="col-12 second_row">
          <h1>Why You Should Invest Now With Sipto?</h1>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus illum fugit quam laborum libero est asperiores aperiam commodi, harum odio nam sequi perspiciatis magnam qui animi consequuntur ullam. Magnam, voluptatem.</p>
          <button className='btn btn-primary'>Invest Now</button>
        </div>
      </div>
      <div className="row seventh_row">
        <div className="col-md-12 second_row">
          <h1>What people say about Sipto?</h1>
          <Massages Name={'Vikas Sharma'}/>
          <Massages Name={'Sidarth Sharma'}/>
          <Massages Name={'Yash Sharma'}/>
          </div>
        </div>
    </>
  )
